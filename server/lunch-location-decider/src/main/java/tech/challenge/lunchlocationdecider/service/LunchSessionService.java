...
import tech.challenge.lunchlocationdecider.util.NullCheckUtil;
...
public class LunchSessionService {
    ...
    public LunchSessionDto newLunchSession() {
    ...
    public LunchSessionDto findLunchSession(LunchSessionDto lunchSessionDto) {
        NullCheckUtil.lunchSessionDtoNullCheck(lunchSessionDto);
        String roomCode = lunchSessionDto.getRoomCode();
        ...
        boolean hasOwnerCode = lunchSessionDto.getOwnerCode().equals(lunchSessionEntity.getOwnerCode());
